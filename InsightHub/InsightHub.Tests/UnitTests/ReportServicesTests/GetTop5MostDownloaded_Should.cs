...
{
    [TestClass]
    public class GetTop5MostDownloaded_Should
    {
        [TestMethod]
        public async Task GetsTop5DownloadedReports_When_ParamsValid()
        {
            var options = Utils.GetOptions(nameof(GetsTop5DownloadedReports_When_ParamsValid));
