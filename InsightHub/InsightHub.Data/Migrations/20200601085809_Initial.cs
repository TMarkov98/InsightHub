    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 3, "9f3ee546-2e61-4f09-b18c-3579a81a9082", "Client", "CLIENT" },
                    { 2, "91ff1cd3-c18a-4dc8-a994-9f79ed3ffd60", "Author", "AUTHOR" },
                    { 1, "32f9f093-f178-46f6-b0cf-5ec396ccd77e", "Admin", "ADMIN" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 3, 0, null, "caea7696-1df2-4c65-ac99-f68cee3fb1fd", new DateTime(2020, 6, 1, 8, 58, 8, 261, DateTimeKind.Utc).AddTicks(1137), "client@gmail.com", false, "Clientcho", false, false, "Clientev", true, null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "CLIENT@GMAIL.COM", "CLIENT@GMAIL.COM", "AQAAAAEAACcQAAAAEKi7Q/vYUJF3+qJGCSIPjZxHcj2tjID1+/Bxr98ujB65JEszegX/DPzdrlKL2gDhCQ==", null, false, null, "7I5VNHIJTSZNOT3KDWKNFUV5PVYBHGXF", false, "client@gmail.com" },
                    { 1, 0, null, "c9ba3de3-5be6-4257-a401-5c0e392bd3c4", new DateTime(2020, 6, 1, 8, 58, 8, 260, DateTimeKind.Utc).AddTicks(8846), "admin@gmail.com", false, "Admincho", false, false, "Adminev", true, null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "ADMIN@GMAIL.COM", "ADMIN@GMAIL.COM", "AQAAAAEAACcQAAAAEEsdyIBxGQ1SEiZvOH02ZEVvwDCbunhClvHoPVt5RZiEPI976HlhyLKmcqzi+t/8AA==", null, false, null, "7I5VNHIJTSZNOT3KDWKNFUV5PVYBHGXN", false, "admin@gmail.com" },
                    { 2, 0, null, "85f9a9d1-92b4-42b4-aea8-9eedf1d861d2", new DateTime(2020, 6, 1, 8, 58, 8, 261, DateTimeKind.Utc).AddTicks(1114), "author@gmail.com", false, "Authorcho", false, false, "Authorchevski", true, null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "AUTHOR@GMAIL.COM", "AUTHOR@GMAIL.COM", "AQAAAAEAACcQAAAAEIaGiPCT8hLp8YJ0JZmEs9w6TX2dsCQmYAMSkF1OgBiX7xJrhwTfitxq1r4syfzbQg==", null, false, null, "7I5VNHIJTSZNOT3KDWKNFUV5PVYBHGXV", false, "author@gmail.com" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 17, new DateTime(2020, 6, 1, 8, 58, 8, 303, DateTimeKind.Utc).AddTicks(6168), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "https://i.imgur.com/fJ5s33U.png", false, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Restaurants" },
                    { 16, new DateTime(2020, 6, 1, 8, 58, 8, 303, DateTimeKind.Utc).AddTicks(6145), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "https://i.imgur.com/GMNHXMs.png", false, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Tourism" },
                    { 15, new DateTime(2020, 6, 1, 8, 58, 8, 303, DateTimeKind.Utc).AddTicks(6122), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "https://i.imgur.com/oWIukyA.png", false, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Food" },
                    { 14, new DateTime(2020, 6, 1, 8, 58, 8, 303, DateTimeKind.Utc).AddTicks(6098), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "https://i.imgur.com/5pZJcpA.png", false, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Energy" },
                    { 12, new DateTime(2020, 6, 1, 8, 58, 8, 303, DateTimeKind.Utc).AddTicks(6053), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "https://i.imgur.com/WeTQtUK.png", false, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Education" },
                    { 13, new DateTime(2020, 6, 1, 8, 58, 8, 303, DateTimeKind.Utc).AddTicks(6075), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "https://i.imgur.com/ApJqXTX.png", false, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Technology" },
                    { 10, new DateTime(2020, 6, 1, 8, 58, 8, 303, DateTimeKind.Utc).AddTicks(6007), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "https://i.imgur.com/TFcnTmD.png", false, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Fashion" },
                    { 9, new DateTime(2020, 6, 1, 8, 58, 8, 303, DateTimeKind.Utc).AddTicks(5971), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "https://i.imgur.com/MIkU108.jpg", false, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Casino" },
                    { 8, new DateTime(2020, 6, 1, 8, 58, 8, 303, DateTimeKind.Utc).AddTicks(5948), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "https://i.imgur.com/0aD3uZj.jpg", false, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Agriculture" },
                    { 7, new DateTime(2020, 6, 1, 8, 58, 8, 303, DateTimeKind.Utc).AddTicks(5926), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "https://i.imgur.com/io9aGef.jpg", false, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Building" },
                    { 6, new DateTime(2020, 6, 1, 8, 58, 8, 303, DateTimeKind.Utc).AddTicks(5902), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "https://i.imgur.com/evwFFDj.png", false, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Space" },
                    { 5, new DateTime(2020, 6, 1, 8, 58, 8, 303, DateTimeKind.Utc).AddTicks(5874), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "https://i.imgur.com/MWr58IA.png", false, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Business Services" },
                    { 4, new DateTime(2020, 6, 1, 8, 58, 8, 303, DateTimeKind.Utc).AddTicks(5850), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "https://i.imgur.com/AO7gOGs.png", false, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Automobile" },
                    { 3, new DateTime(2020, 6, 1, 8, 58, 8, 303, DateTimeKind.Utc).AddTicks(5824), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "https://i.imgur.com/TC7qZPP.png", false, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Healthcare" },
                    { 2, new DateTime(2020, 6, 1, 8, 58, 8, 303, DateTimeKind.Utc).AddTicks(5774), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "https://i.imgur.com/dX9t5lS.png", false, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Airlines" },
                    { 11, new DateTime(2020, 6, 1, 8, 58, 8, 303, DateTimeKind.Utc).AddTicks(6030), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "https://i.imgur.com/ArAIUQ0.png", false, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Blockchain" },
                    { 1, new DateTime(2020, 6, 1, 8, 58, 8, 303, DateTimeKind.Utc).AddTicks(4670), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "https://i.imgur.com/8Rkh6JW.png", false, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Finance" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2020, 6, 1, 8, 58, 8, 303, DateTimeKind.Utc).AddTicks(9475), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), false, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Space" },
                    { 2, new DateTime(2020, 6, 1, 8, 58, 8, 304, DateTimeKind.Utc).AddTicks(526), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), false, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Water" },
                    { 3, new DateTime(2020, 6, 1, 8, 58, 8, 304, DateTimeKind.Utc).AddTicks(576), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), false, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Money" }
                });
