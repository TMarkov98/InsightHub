    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 3, "d4dd2bef-4a67-4364-ae8a-8e9e524eb00b", "Client", "CLIENT" },
                    { 2, "28993bab-306f-4000-b449-6d28ac769d1e", "Author", "AUTHOR" },
                    { 1, "4db493f5-605d-48bf-bd87-da2ed25d2869", "Admin", "ADMIN" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 3, 0, null, "da129eeb-ff78-4eef-9085-8732e3f38a15", new DateTime(2020, 6, 7, 20, 3, 43, 241, DateTimeKind.Utc).AddTicks(1771), "client@gmail.com", false, "Clientcho", false, false, "Clientev", true, null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "CLIENT@GMAIL.COM", "CLIENT@GMAIL.COM", "AQAAAAEAACcQAAAAEAb2Jmzwi+9kgud3n9jV9ofAa/7UEEHosfjQej5kCiAWaYR0liwgwQAYK8czxQ3m4g==", null, false, null, "7I5VNHIJTSZNOT3KDWKNFUV5PVYBHGXF", false, "client@gmail.com" },
                    { 1, 0, null, "00d0950e-7fa9-470e-b2f0-c7a6ee494593", new DateTime(2020, 6, 7, 20, 3, 43, 241, DateTimeKind.Utc).AddTicks(497), "admin@gmail.com", false, "Admincho", false, false, "Adminev", true, null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "ADMIN@GMAIL.COM", "ADMIN@GMAIL.COM", "AQAAAAEAACcQAAAAEH53ioUWdbG4G5Pwncza2AKGgpIURo5pE/w5tz9A33e/uaiG4CbSvW7zaFNuYn/vaA==", null, false, null, "7I5VNHIJTSZNOT3KDWKNFUV5PVYBHGXN", false, "admin@gmail.com" },
                    { 2, 0, null, "3ea25f1d-5a65-433d-ad76-ea7dc53ed544", new DateTime(2020, 6, 7, 20, 3, 43, 241, DateTimeKind.Utc).AddTicks(1756), "author@gmail.com", false, "Authorcho", false, false, "Authorchevski", true, null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "AUTHOR@GMAIL.COM", "AUTHOR@GMAIL.COM", "AQAAAAEAACcQAAAAELKbdDg1U4l9mgd0gO7DCZF0jlCe6uUV99v1FwY5hU9AlJRsaZd5N8mSJ5m5x+Kd1Q==", null, false, null, "7I5VNHIJTSZNOT3KDWKNFUV5PVYBHGXV", false, "author@gmail.com" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 17, new DateTime(2020, 6, 7, 20, 3, 43, 264, DateTimeKind.Utc).AddTicks(2430), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "https://i.imgur.com/fJ5s33U.png", false, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Restaurants" },
                    { 16, new DateTime(2020, 6, 7, 20, 3, 43, 264, DateTimeKind.Utc).AddTicks(2417), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "https://i.imgur.com/GMNHXMs.png", false, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Tourism" },
                    { 15, new DateTime(2020, 6, 7, 20, 3, 43, 264, DateTimeKind.Utc).AddTicks(2404), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "https://i.imgur.com/oWIukyA.png", false, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Food" },
                    { 14, new DateTime(2020, 6, 7, 20, 3, 43, 264, DateTimeKind.Utc).AddTicks(2391), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "https://i.imgur.com/5pZJcpA.png", false, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Energy" },
                    { 12, new DateTime(2020, 6, 7, 20, 3, 43, 264, DateTimeKind.Utc).AddTicks(2365), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "https://i.imgur.com/WeTQtUK.png", false, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Education" },
                    { 13, new DateTime(2020, 6, 7, 20, 3, 43, 264, DateTimeKind.Utc).AddTicks(2378), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "https://i.imgur.com/ApJqXTX.png", false, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Technology" },
                    { 10, new DateTime(2020, 6, 7, 20, 3, 43, 264, DateTimeKind.Utc).AddTicks(2338), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "https://i.imgur.com/TFcnTmD.png", false, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Fashion" },
                    { 9, new DateTime(2020, 6, 7, 20, 3, 43, 264, DateTimeKind.Utc).AddTicks(2324), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "https://i.imgur.com/MIkU108.jpg", false, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Casino" },
                    { 8, new DateTime(2020, 6, 7, 20, 3, 43, 264, DateTimeKind.Utc).AddTicks(2311), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "https://i.imgur.com/0aD3uZj.jpg", false, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Agriculture" },
                    { 7, new DateTime(2020, 6, 7, 20, 3, 43, 264, DateTimeKind.Utc).AddTicks(2297), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "https://i.imgur.com/io9aGef.jpg", false, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Building" },
                    { 6, new DateTime(2020, 6, 7, 20, 3, 43, 264, DateTimeKind.Utc).AddTicks(2279), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "https://i.imgur.com/evwFFDj.png", false, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Space" },
                    { 5, new DateTime(2020, 6, 7, 20, 3, 43, 264, DateTimeKind.Utc).AddTicks(2223), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "https://i.imgur.com/MWr58IA.png", false, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Business Services" },
                    { 4, new DateTime(2020, 6, 7, 20, 3, 43, 264, DateTimeKind.Utc).AddTicks(2209), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "https://i.imgur.com/AO7gOGs.png", false, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Automobile" },
                    { 3, new DateTime(2020, 6, 7, 20, 3, 43, 264, DateTimeKind.Utc).AddTicks(2193), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "https://i.imgur.com/TC7qZPP.png", false, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Healthcare" },
                    { 2, new DateTime(2020, 6, 7, 20, 3, 43, 264, DateTimeKind.Utc).AddTicks(2162), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "https://i.imgur.com/dX9t5lS.png", false, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Airlines" },
                    { 11, new DateTime(2020, 6, 7, 20, 3, 43, 264, DateTimeKind.Utc).AddTicks(2352), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "https://i.imgur.com/ArAIUQ0.png", false, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Blockchain" },
                    { 1, new DateTime(2020, 6, 7, 20, 3, 43, 264, DateTimeKind.Utc).AddTicks(1559), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "https://i.imgur.com/8Rkh6JW.png", false, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Finance" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2020, 6, 7, 20, 3, 43, 264, DateTimeKind.Utc).AddTicks(4145), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), false, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Space" },
                    { 2, new DateTime(2020, 6, 7, 20, 3, 43, 264, DateTimeKind.Utc).AddTicks(4698), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), false, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Water" },
                    { 3, new DateTime(2020, 6, 7, 20, 3, 43, 264, DateTimeKind.Utc).AddTicks(4739), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), false, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Money" }
                });
